...
-- Append-only proof of explicit policy acceptance during account creation.
...
ALTER TABLE platform_settings ADD COLUMN IF NOT EXISTS billing_config JSONB DEFAULT '{}'::jsonb;
...
-- This service uses only its private PostgreSQL connection. Do not expose
-- tenant tables, sequences, or routines through Supabase Data API roles.
